	  		...
	  		<div class="container">
	  			<div class="row">
		            ...
		            <?php if( get_theme_mod( 'stock_photos_site_title',true) != '') { ?>
			            ...
			            <?php endif; ?>
				        <?php }?>
				        <?php if( get_theme_mod( 'stock_photos_site_tagline',true) != '') { ?>
			            <?php
	  	...
	  	<div class="menu-section">
	  		<div class="row me-0">
	  			<div class="col-lg-8 col-md-6 align-self-center">
	  				<div class="menubox ps-md-5 <?php if( get_theme_mod( 'stock_photos_sticky_header') != '') { ?> sticky-header<?php } else { ?>close-sticky my-md-0 my-4 <?php } ?>">
